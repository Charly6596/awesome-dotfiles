...
function helpers.get_active_bartheme()
    local f = io.open("active-bartheme", "r")
    if f == nil then
        return "skyfall"
    end
...
function helpers.set_active_bartheme(t)
    local f = io.open("active-bartheme", "w")
    f:write(t)
    f:close()
end
...
function helpers.get_active_theme()
    local f = io.open("active-theme", "r")
    if f == nil then
        return "skyfall"
    end
...
function helpers.set_active_theme(t)
    local f = io.open("active-theme", "w")
    f:write(t)
    f:close()
end
